                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="mt-3 flex flex-wrap gap-2">
                        {skill.scopes.slice(0, 2).map((scope) => (
                          <React.Fragment key={scope}>{renderScopeBadge(scope)}</React.Fragment>
                        ))}
                        {skill.scopes.length > 2 ? <Badge variant="outline">+{skill.scopes.length - 2}</Badge> : null}
                      </div>
                    </button>
                  );
                })}
